...
const baseline = await rebuildPackage(values['baseline-core-directory'], '@singapor/core')
const candidate = await rebuildPackage(values['candidate-core-directory'], '@singapor/core')
...
try {
  ...
  const expectedBaseline = await rebuildPackage(directory, '@singapor/core')
  ...
  const rebuilt = await rebuildPackage(directory, '@singapor/core')
